"""
Django settings for adv_icon_test_3 project.
...
ROOT_URLCONF = 'adv_icon_test_3.urls'
...
WSGI_APPLICATION = 'adv_icon_test_3.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "adv_icon_test_3 API",
    "DESCRIPTION": "API documentation for adv_icon_test_3 App",
    "VERSION": "v1",
}
